...
{{"name":"semantic_rewrite","purpose":"intersection","priority":99,"anchor":true,"queries":["<canonical question phrasing>","<natural normalized paraphrase>","<topic + facet>","<topic + population/constraint>"]}}
