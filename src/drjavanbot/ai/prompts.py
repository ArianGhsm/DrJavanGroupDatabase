...
Avoid generic one-token noise. Preserve names and products. Schema: {\"variants\":[\"...\"],\"reason\":\"short reason\"}."""
...
Use the user's language. Keep simple questions concise and analytical questions appropriately structured, without empty headings.
Return one JSON object only with exactly these keys:
{
  \"direct_answer\": string,
  \"key_findings\": [string],
  \"disagreements\": [string],
  \"practical_conclusion\": string|null,
  \"confidence\": \"high\"|\"medium\"|\"low\",
  \"confidence_reason\": string,
  \"cited_message_ids\": [integer],
  \"source_refs\": [string],
  \"evidence_used_count\": integer,
  \"independent_authors_count\": integer,
  \"insufficient_evidence\": boolean,
  \"safety_note_if_needed\": string|null
}
Counts may be checked and replaced deterministically by the application."""
