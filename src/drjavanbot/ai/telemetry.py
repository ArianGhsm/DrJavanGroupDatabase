...
class TelemetryStore:
    """Metadata-only usage log. Prompts, responses, headers and secrets are never persisted."""
        ...
        *,
        ...
        with self._connect() as con:
            con.execute(
                ...
                "cost_irt,cost_unit,exchange_rate,latency_ms,success,error_class) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)",
                (
                    ...
                    float(latency_ms), 1 if success else 0, error_class,
                ),
            )
